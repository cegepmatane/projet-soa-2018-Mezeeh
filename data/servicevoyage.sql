...
INSERT INTO `voyage` (`id`, `nom`, `destination`, `description`, `distance`, `idvaisseau`) VALUES
...
(5, 'le voyage de plis', 'Polis Massa', 'Cet espace rocailleux rocheux a la particularité d\'être le lieu de naissance de Luke et Leia (ainsi que le lieu de la mort de Padmé Amidala), et pas grand-chose d\'autre.', 5000212, 3),
(6, 'le voyage de wowo', 'Wobani', 'C\'est la planète de la prison déserte que Jyn Erso a sauvée au début de Rogue One .', 43251, 4),
(7, 'le voyage de Ea', 'Eadu', 'Rogue One avait des planètes merdiques, n\'est-ce pas? Celui-ci est génial si vous aimez la pluie, le meurtre, les scientifiques retenus contre leur volonté, et les falaises.', 453264532, 3),
(8, 'le voyage de hos', 'Hosnian Prime', 'Hosnian Prime c\'est une ville planétaire située près du noyau de la galaxie.', 342, 5),
(9, 'le voyage hots', 'Hoth ', 'C\'est une planète de glace inhospitalière dont le prédateur de l\'apex est le cousin moins baisable de l\'abominable bonhomme de neige, mais il abrite aussi les tauntauns, le meilleur animal de Star Wars .', 345576, 4),
(10, 'le voyage de jaja\r\n', 'Jakku', 'Ce n\'est pas Tatooine. Au contraire, cette planète désertique semble être encore plus éloignée que l\'ancienne, qui avait au moins assez d\'économie pour soutenir un circuit de podrace en plein essor.', 24653, 5),
(11, 'le voyage de Je', 'Jedha ', 'Pour mon argent, voici la nouvelle planète Star Wars (techniquement c\'est une lune) qui sent le Star Wars- esque.', 4351313, 1),
(12, 'le voyage de tat', 'Tatooine', 'Comme l\'île de Lost , Tatooine a perdu sa mystique au fur et à mesure que nous la voyions, car il s\'avérait que la planète abritait aussi une limace qui était le plus redouté des criminels de la Galaxie, un gros trou avec des dents, un tas de podracers, et, il était une fois, l\'enfant qui deviendrait Dark Vador. Pourtant, nous aurons toujours ce coucher de soleil binaire et la cantina Mos Eisley , qui nous a dit tout ce que nous avions besoin de savoir sur cet étrange nouvel univers.', 1289347, 1);
